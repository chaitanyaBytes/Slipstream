...
impl From<tonic::Status> for SlipstreamError {
    fn from(err: tonic::Status) -> Self {
        SlipstreamError::GrpcStatusError(Box::new(err))
    }
}

impl From<solana_client::client_error::ClientError> for SlipstreamError {
    fn from(err: solana_client::client_error::ClientError) -> Self {
        SlipstreamError::SolanaClientError(Box::new(err))
    }
}
